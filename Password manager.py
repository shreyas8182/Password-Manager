...
# ---------------------------- WIDGETS SETUP ------------------------------- #
# canvas widget
#PASS_IMG = PhotoImage(file="C:/Users/Shreyas/Documents/youtube/python/lock.jpg")
...
generate_button = Button(text="Generate Password", command=get_password, font=FONT, state = "disabled")
